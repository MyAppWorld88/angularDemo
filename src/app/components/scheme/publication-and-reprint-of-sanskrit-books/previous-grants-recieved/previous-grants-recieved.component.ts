...
@Component({
  selector: 'app-previous-grants-recieved',
  standalone: true,
  imports: [PrimengModule],
  templateUrl: './previous-grants-recieved.component.html',
  styleUrl: './previous-grants-recieved.component.scss'
})
export class PreviousGrantsRecievedComponent {
  uploadedFiles: any[] = [];
  formData:any;
  fileName:any;
  cities:any;
