...
@Component({
  selector: 'app-publication-submited',
  standalone: true,
  imports: [PrimengModule],
  templateUrl: './publication-submited.component.html',
  styleUrl: './publication-submited.component.scss'
})
export class PublicationSubmitedComponent {
  uploadedFiles: any[] = [];
  formData:any;
  fileName:any;
  cities:any;
