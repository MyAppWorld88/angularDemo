...
@Component({
  selector: 'app-scholar-prefrence',
  standalone: true,
  imports: [PrimengModule],
  templateUrl: './scholar-prefrence.component.html',
  styleUrl: './scholar-prefrence.component.scss'
})
export class ScholarPrefrenceComponent {
  uploadedFiles: any[] = [];
  formData:any;
  fileName:any;
  cities:any;
