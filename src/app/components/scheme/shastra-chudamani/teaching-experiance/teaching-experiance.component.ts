...
@Component({
  selector: 'app-teaching-experiance',
  standalone: true,
  imports: [PrimengModule],
  templateUrl: './teaching-experiance.component.html',
  styleUrl: './teaching-experiance.component.scss'
})
export class TeachingExperianceComponent {
    uploadedFiles: any[] = [];
    formData:any;
    fileName:any;
    cities:any;
